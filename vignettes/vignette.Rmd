...
Promoter (defined as ± 2kb windows centered on RefSeq transcription start site) hypermethylation was measured using differentially hypermethylated cytosine ratio (DHcR), defined as the ratio of hypermethylated cytosines (HCs) to the total number of promoter CpGs profiled. HCs of each sample were defined as CpGs at which DNAme is statistically higher than the average DNAme of control samples (false discovery rate = 20%, Chi-squared test). Only CpGs with read depth greater than 10 were included in the analysis. RRBS data of normal samples were used as control. An implemented function *makeHG19Promoters* was used to provide promoter annotations of hg19 RefSeq genes. Users and define their own annotation.

...
#' @description First, expected DHcR is estimated through beta regression model.
#'     Next, expected DHcR is tested against observed DHcR to evalute if there is promoter hypermethylation.

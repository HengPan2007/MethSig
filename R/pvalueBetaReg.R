...
#' @description Expected DHcR is estimated through beta regression model first. Next, expected DHcR is tested
#'     against observed DHcR to evalute if there is promoter hypermethylation.

...
A matrix of covariates used in the beta regression model is needed. The matrix needs to include a column of hugo gene symbol and at least one column of the covariate. An example can be loaded by *invisible(matCV)*.

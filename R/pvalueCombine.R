...
#' @param data A data frame object generated by pvalueBetaReg function. The object contains following columns:
...
#' @param K Single integer value > 0L. The size of random sampling.
#' @param times Single integer value > 0L. The times of random sampling.
#' @param r Use the rth smallest p-value in Wilkinson combination.
#' @return A data frame summarizing inference of cohort-prevalent hypermethylation.
#'     \itemize{

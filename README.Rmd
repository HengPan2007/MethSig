...
As mentioned in the **Prerequisite** section, users need to put DMC.sample_name.txt and PDR.sample_name.txt files in the input_dir folder. Also, a user defined covarites matrix is needed.
```{r, eval = F}

...
#' @description Expected DHcR was estimated through beta regression model first. Next, expected DHcR was tested
#'     against observed DHcR to evalute if there was promoter hypermethylation.
#' @param formula An object of class "formula" (or one that can be coerced to that class):
#'     a symbolic description of the model to be fitted. The name of y variable should be DHcR_Tumor_Beta.
#' @param data A data frame object generated by \emph{makeInputMatrix}.
...
#'     were added to the input matrix.
#'     \itemize{

...
## Introduction
MethSig is used to to infer DNA methylation drivers from bisulfite converted data of cancer cohorts.

## Prerequisite

### 1. Data alignment and processing.
Bisulfite converted data are aligned and processed as described in our published book chapter (Pan \emph{et al.}, \emph{Cancer Systems Biology}, 2018)

### 2. Preparation of covariate matrix.
A matrix of covariates, which are used in the beta regression model, is needed. The matrix needs to include a column of hugo gene symbol and at least one column of the covariate. An example can be loaded by \emph{invisible(matCV)}.
